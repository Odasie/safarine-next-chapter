...
const ProDashboard = () => {
  ...
  return <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50">
        {/* Compact Header */}
        <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-blue-100 shadow-sm" style={{
        height: '48px'
      }}>
        ...
        {/* Main Content */}
        <main className="w-full max-w-7xl mx-auto px-4 lg:px-6 py-4 space-y-4">
